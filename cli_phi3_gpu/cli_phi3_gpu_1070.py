# Caminho: C:\Users\anapa\SuperIA\EzioFilhoUnified\cli_phi3_gpu\cli_phi3_gpu_1070.py

"""
CLI Phi-3 Mini — Força uso da GPU 1 (GTX 1070)
Para sair, digite: exit
"""

import os
os.environ["CUDA_VISIBLE_DEVICES"] = "1"  # GTX 1070
...
def main():
    print("==== CLI Phi-3 Mini (GPU 1 — GTX 1070) ====")
